...
@section('title' , 'Controller Add Reviwer')
@section('content')
      <section  id="AddReviwer">
          <div class="card shadow-sm p-4 mb-4 bg-white rounded">
              <div  class=" d-flex justify-content-between mt-2">
                <h2 class="text-black">Add Reviwer</h2>
              </div>
              <p class="lead text-muted">Manage your submissions, track your papers, and stay updated with the latest notifications.</p>
          </div>

        <div class="mt-5" x-data="inviteReviewer()">
            <h2 class="text-center mb-4">Send Reviewer Invitation</h2>
            ...
            <form action="{{ route('send-invitation') }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="message"  class="form-control" x-model="message" required></textarea>
                </div>
