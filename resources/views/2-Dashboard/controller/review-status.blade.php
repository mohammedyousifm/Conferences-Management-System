          ...
          <div class=" shadow-lg border-0 p-1">
              ...
              <div class="card-body">
                 ...
                 {{-- Paper & Author Details --}}
                                  ...
                                  <ul class="m-3 p-1 list-group list-group-flush">
                                      ...
                                      <li class="list-group-item">
                                        ...
                                        @else
                                         ...
                                         <button x-on:click="open = !open; $nextTick(() => { document.querySelector('#commint').scrollIntoView({ behavior: 'smooth' }) })"  class="btn btn-sm bg text ">
                                               ...
                                               <li class="list-group-item">
                                                   ...
                                                   <strong>Comment from Reviewer:</strong>
                                                    <p>{{ $reviewer->comment }}</p>
                                                     ...
                                                     <a href="{{ asset($reviewer->comment_file) }}"  download  class="btn btn-sm bg text " target="_blank">
                  ...
                  {{-- commint --}}
                  <section id="commint" x-show="open" class="p-2 commint" >
                        <form  action="{{ route('report_commint.controller', $paper->id) }}" method="POST" enctype="multipart/form-data"  class="mt-4" >
                                   @csrf
                                   <div class="mb-3">
                                       <label class="form-label m-2 fw-bold">Controller Comment to Author</label>
                                       <textarea name="report_comment" class="form-control" rows="4" placeholder="Write your Commint here..." required></textarea>
                                   </div>

                                <div class="mb-3">
                                       <label for="report_file" class="form-label m-2 fw-bold">Upload File <small>(Optional)</small></label>
