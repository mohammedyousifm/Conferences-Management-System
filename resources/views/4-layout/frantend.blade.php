            ...
            <div class="header-row">
                ...
                <div id="logo">
                    <a href="https://www.lpu.in">
                        <img src="{{ asset('3-images/logo1.jpg') }}" alt="LPU LOGO" width="200" height="100"
                            class="scroll-logo" />
                        <img src="https://www.lpu.in/lpu-assets/images/logo/naac-logo.svg" alt="LPU LOGO" width="130"
                            height="120" class="naac-logo" />
                    </a>
                </div>
                <div class="header-right">
                    <div class="top-links">
                        <ul class="top-links-container">
                            ...
                            <li class="top-links-item d-lg-none d-sm-block"><a
                                    ...
                                    style="border-color:#ef7d00;">Admissions</a></li>
                            <li class="top-links-item d-lg-none d-sm-block"><a
                    ...
                    <div class="menu-wrapper">
                            ...
                            <nav class="primary-menu">
                                <ul class="menu-container">
                                    ...
                                    <li class="menu-item current">
                                        <a class="menu-link" href="#">
                                            <div>About us <i class="fa-solid  text-bg fa-arrow-down" style="font-size: 12; padding-top: 10px;"></i></div>
                                        </a>
                        ...
                        @else
                        <div class="nav-apply-now">
                            <a class="nav-apply-now bg" href="{{ route('register') }}" target="_blank">
                                Sign in
                            </a>
                        </div>
                        <div class="nav-apply-now">
                            <a data-gtm-title="Apply" data-gtm-ps-applynow="LPU Homepage Menu"
                                href="{{ route(name: 'login') }}" target="_blank">
                                Sign up
                            </a>
                        </div>
                        @endif
                ...
                <div class="row gy-3 align-items-sm-center">
                    <div class="col-12 col-sm-6">
                        <div class="footer-logo-wrapper text-start">
                            <a href="#!">
                                <img src="{{ asset('3-images/logo.png') }}" width="100" loading="lazy"
                                    alt="BootstrapBrain Logo" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6">
                                ...
                                <li>
                                    <a href="#!" class="btn btn-outline-light bsb-btn-circle bsb-btn-circle">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            fill="currentColor" class="bi bi-facebook text-lightx" viewBox="0 0 16 16">
                                            <path
